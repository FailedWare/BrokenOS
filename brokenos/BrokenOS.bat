...
echo Hello, %user%!
echo.
echo [COLOR] [CAN BE CHANGED LATER]
echo.
echo 01 - navy
echo 02 - green
echo 03 - teal / cyan
...
title BrokenOS / User: %user%
echo.
echo BrokenOS V.7.1.1
echo.
echo Welcome, %user%!
echo.
echo (7.2) Removed a few files because I want to upload this to GitHub
echo.
echo (7.1) added the ability to use lower-case keys on the Presetup! (Should've been done on Version 1 or 2)
echo.
echo (7.0) Changed a lot of stuff!
echo.
